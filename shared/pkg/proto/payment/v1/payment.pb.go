...
// Package payment.v1 содержит API для работы с PaymentService
...
// PayOrderRequestRequest запрос на оплату заказа
...
type PayOrderResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// transaction_uuid идентификатор проведённой транзакции
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB\\ZZgithub.com/RustamRuzibaev/microservices_2_homework1/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
